...
//---------------------------------------------------------------------------------------
// returns 0 in r0 if the player name isn't "HARD MODE" ("MODE EXTRÊME"). Returns non-zero if it is.
//---------------------------------------------------------------------------------------
...
cmp  r1,#0xD
beq  .elision_hinawa               // if parameter is D => hinawa’s name
...
ldr  r3,=#0x200417E                // starting point for character names (0x2004112 + 0x6C)
ldr  r2,=#0x6C                     // interval between character names in ram
mul  r1,r2
add  r3,r3,r1
...
.elision_hinawa:
ldr  r3,=#0x2004EE2                // hinawa’s name in memory
+
