...
public class CheckOverflow
{
	...
	*/
	...
	private static void fillWidths() {
		...
		normalWidths.put(".", 3);
		normalWidths.put("/", 5);
		normalWidths.put("0", 5);
		normalWidths.put("1", 3);
		normalWidths.put("2", 5);
		normalWidths.put("3", 5);
		normalWidths.put("4", 6);
		normalWidths.put("5", 5);
		normalWidths.put("6", 5);
		normalWidths.put("7", 5);
		normalWidths.put("8", 5);
		normalWidths.put("9", 5);
		normalWidths.put(":", 3);
		normalWidths.put(";", 4);
		normalWidths.put("<", 7);
		normalWidths.put("=", 6);
