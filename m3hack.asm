...
org $8040902; db $BF
org $8040A82; db $B4         // Equip
org $8043016; db $B4
org $804121E; db $BC                  // Skills
org $8040C26; db $C5         // PSI
org $80410AE; db $BE         // Status
org $804167E; db $AD         // Battle Memory
org $8041886; db $BB         // Shop
org $8041990; db $BB
org $8041D00; db $BB
org $804181A; db $BB
...
// Shut the weird sound on naming screen
org $804DD1C; nop; nop
org $804DD66; nop; nop
...
org $809E3A8; bl battle_hacks.save_current_enemy_19      //Status dancing
...
// eat stew and soup instead of drinking them
org $80E8914; db $46
org $80E8548; db $46
...
org $9C8F357; db $40 // Make final sprite 32x16 instead of 16x16
org $9C8F334; db $8F // Move the flashy text left by 9 pixels
org $9C8F33A; db $AF
org $9C8F340; db $CF
org $9C8F346; db $EF
org $9C8F34C; db $0F
...
org $9FDFC00; incbin gfx_healthtext_[c].bin
org $9C8DEA8; dd $00351D68
...
// Knock-knock sprites
org $9640A30; incbin gfx_knock.bin
...
org $8065658; db $3C // full 1st line, left 6 pixels back
...
org $9AF6480; incbin gfx_pvpp.bin


// Insert PV and PP indicators for battles
org $9C9B108; incbin gfx_battle_pvpp.bin


// Replace save screen indicators
org $9B9CB30; incbin gfx_savescreen.bin


// Replace text for sound test
org $9CA6D08; incbin gfx_soundplayer.bin


// Replace text for title screen
org $9BCDE60; dd $40BFD4
org $9FD9D60; incbin gfx_titlescreen_[c].bin
...
// Replace title logo
//org $9BD4338; incbin gfx_titlelogo_mere_[c].bin
//org $9BD6140; incbin gfx_titlelogo_arrangement_mere.bin
...
org $8D3C0F0; dd $124CCC0
org $9F881A0; incbin gfx_bazaar1_[c].bin
org $8D3C0F4; dd $126EEE4
org $9FAA3C4; incbin gfx_bazaar2_[c].bin
...
// Insert up/down stats
org $9B9D564; incbin gfx_up_down_[c].bin


// Insert Start Battle text
org $9B90030; dd $004023B0
org $9F92370; incbin gfx_start_battle_[c].bin


// Insert Exit (Battle Memory)
org $9C97F88; incbin gfx_exit.bin
org $9C97D88; incbin gfx_exit2.bin
...
org $8D3B720; dd $12545C0
org $9F8FAA0; incbin gfx_tower_elevator_in_[c].bin


// Insert elevator sign for Thunder Tower (outside)
org $8D3B870; dd $124FA20
org $9F8AF00; incbin gfx_tower_elevator_out_[c].bin


// Fixes TaneTane Island’s glitched tileset
org $8FC8CA8; incbin gfx_tanetane_layer1_arrangement_[c].bin
org $9F8B4F0; incbin gfx_tanetane_layer2_arrangement_[c].bin
org $8F904B8; dd $00FFB4B4 //Layer 2’s pointer
org $9F8BBA0; incbin gfx_tanetane_layer3_arrangement_[c].bin
org $8F904BC; dd $00FFBB64 //Layer 3’s pointer
...
// Insert graphics for lab floors and elevators
org $8D5D0A8; incbin gfx_labelevator1_[c].bin
org $8D70764; incbin gfx_labelevator2_[c].bin
org $8D5E7E4; incbin gfx_labelevatordoor1_[c].bin
org $8D70DCC; incbin gfx_labelevatordoor2_[c].bin
org $8D3BB5C; dd $124FD20
org $9F8B200; incbin gfx_labwall_[c].bin
...
// Insert Thomas Bazaar for credits
org $9C68744; incbin gfx_credits_bazaar.bin
...
// insert music titles
org $8086CF4; dd $09FC7000
org $9C8F38C; dd $09FC7000
org $9FC7000; incbin text_musicnames.bin


// move music text to the left
org $8066B86; db $2A
...
org $8D1EE88; dd $FFFDF530
org $8D1EE8C; dd $FFFDF730
org $8CFE3A8; incbin text_itemdescriptions.bin
...
org $9AF3824; dd $FF214748
org $9AF3828; dd $FF21479E
org $8D07ED8; incbin text_menus3.bin
...
//org $9FAC000; incbin gfx_disclaim_mere_[c].bin
...
org $813C700
hardmodestring:
dw $007E,$002F,$0024,$0025,$0040,$0025,$0038,$0034,$0032,$006C,$007E,$0025,$FFFF,$FFFF


// string used to determine if elision is needed before writing the favorite food
org $813C720
vowelstring:
db $21,$41,$25,$45,$29,$49,$2F,$4F,$35,$55,$62,$80,$64,$82,$6B,$89,$6A,$88,$6C,$8A,$6D,$8B,$70,$8E,$71,$8F,$76,$94,$7C,$9A,$FF
...
//Fixes issue with sound at Lydia’s House (Map 0x4F), the Mechorilla’s sounds are all late normally
org $8C9505A; db $A2
...
//Stone Sheet Clippers memo flag
org $92AA7F8; dd $0D31000C
org $92AB900; incbin logic_set_ssc.bin


define NEW_PLACE_1 $9FD5F00
org {NEW_PLACE_1}; incbin logic_142_pointers.bin
org $9199624; dd {NEW_PLACE_1}-$9198C10


//Porky memo flag
org $92F8ABC; dd $031F000C
org $92F8B0C; incbin logic_set_porky.bin
...
//OLD STUFF ----------------------------------------------------------------------------
//
// Remove various entries in summary
//org $8042E28; ldr r0,=#0x8042E45; bx r0 //Removes “Favourite Food:”
//org $8042DD6; ldr r0,=#0x8042DF9; bx r0 //Removes “Favourite Thing:”
//org $8042E70; ldr r0,=#0x8042EB3; bx r0 //Removes Both “Text Speed:” and “Fast/Medium/Slow”
//
// Insert the hack for fast/medium/slow speed in summary
//org $9FD0200; dd $00000002
//org $9FD0204; dd $0000000C
//org $9FD0208; dd $0000080C
//org $9FD020C; incbin gfx_summary_arrangement_fast.bin
//org $9FD0A0C; incbin gfx_summary_arrangement_slow.bin
//
//org $8042F06; mov r1,#0x9F; lsl r1,r1,#0x14; mov r2,#0x0D0; lsl r2,r2,#0x0C; add r1,r1,r2; add r1,r1,#1; bx r1
//
// Insert the hack code for summary page confirm
//org $9FD0000
//incsrc summary_confirm_hacks.asm
//org $804A380; dd $09FD0111 //Change address loaded
