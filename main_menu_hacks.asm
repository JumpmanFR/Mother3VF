...
//   [15 EF] - Prints t/vent (accord du verbe) depending on the item
//   [16 EF] - Prints e/s/es (accord de l’objet) depending on the item
//   [17 EF] - Prints le/les/la (COD de l’objet) depending on the item
//
...
mov  r1,#8                   // 8 article entries per letter (MODIF ICI)
mul  r0,r1                   // r3 = item num * 8
...
mov r0,#0
str r0,[r1,#0] //Set the letters count to 0
str r0,[r1,#0x10]
str r0,[r1,#0x14]
str r0,[r1,#0x18]
str r0,[r1,#0x1C]
