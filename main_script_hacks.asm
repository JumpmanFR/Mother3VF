...
// ----------------
cmp  r0,#0xD0           // Jumpman’s hack to handle new custom codes [EF D0] [EF E0]
blt  .no_elision       // to add "de "/"d’" before names or fav food; also "ce "/"cet"


mov  r2,#8


cmp  r0,#0xE0           // 0xE0 or 0xD0 depending on de/d’ (e/’) or ce/cet
blt  +
add  r2,#0x19           // if de/d’, the articles are further down in custom text
+


mov  r1,#0xF
and  r1,r0              // we store the low part of r0 in r1
...
mov  r1,#8
mul  r0,r1             // offset = item ID * 8 bytes !!MODIF!!
...
// ----------------
cmp  r0,#0xD0                // Jumpman’s hack to handle new custom codes [EF E0]
blt  .chap_end_no_elision   // to add "de "/"d’" before names or fav food
